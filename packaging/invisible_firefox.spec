# PyInstaller spec - invisible_firefox (onedir, cross-platform).
# Build:  pyinstaller packaging/invisible_firefox.spec
...
datas += collect_data_files("invisible_firefox", includes=["**/*.html"])  # ui/web/index.html
hiddenimports = (
    collect_submodules("invisible_core")
    + collect_submodules("invisible_firefox")
